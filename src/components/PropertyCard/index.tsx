...
const PropertyCard: React.FC<PropertyCardProps> = ({
    ...
    return (
        <div
            className={`bg-white mx-3 flex ${isRow ? "flex-row" : "flex-col"}`}
        >
            {isNew && (
                <div className="absolute top-5 left-7 py-2 px-4 rounded-3xl bg-primary flex items-center justify-center">
            ...
            {isRow ? (
                ...
                <div className="flex-1 flex flex-col">
                    <div className="flex border-b-2 border-card items-center justify-between w-full py-2 px-4">
                        <div className="flex-none">
                            <p className="text-base text-cardGray1">For sale</p>
                        </div>
                        <div className="flex-none">
                            <p className="text-base text-cardGray1">House</p>
                        </div>
                    </div>
                    ...
                    <div className="flex border-t-2 border-card items-center w-full py-1 px-4 relative">
                        <div
