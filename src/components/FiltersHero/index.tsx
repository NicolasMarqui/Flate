...
const FiltersHero: React.FC<FiltersHeroProps> = ({ estates, countries }) => {
    ...
    return (
        <div className="mt-10 flex flex-col md:flex-row">
            {/* First Filter */}
            <div
                className="bg-white mt-4 md:mt-0 md:mr-4 rounded-2xl py-4 px-10 flex flex-row items-center justify-center cursor-pointer relative"
            ...
            >
                <div className="flex-none mr-3">
                    <h3 className="text-gray-400 text-xl">Type: </h3>
                </div>
                <div className="flex-none flex items-center">
                    <h4 className="text-lg text-black">
            ...
            >
                <div className="flex-none mr-3">
                    <h3 className="text-gray-400 text-xl">Status: </h3>
                </div>
                <div className="flex-none flex items-center">
                    <h4 className="text-lg text-black">
            ...
            {/* Search */}
            <div
                className="bg-primary mt-4 md:mt-0 md:mr-4 rounded-2xl py-4 px-10 flex flex-row items-center justify-center cursor-pointer hover:bg-primaryHover"
